...
class Workout {
  ...
  _setDescription() {
    ...
    this.description = `${this.type[0].toUpperCase() + this.type.slice(1)} on ${months[month]} ${day}`
  }
...
class App {
  ...
  _newWorkout(e) {
    ...
    if (type === 'cycling') {
      ...
      //? Check if data is valid
      if (!validInputs(distance, duration, elevationGain) || !allPositive(distance, duration)) return alert('Inputs have to be positive numbers!');
